    ...
    def _send(self, auto_commit=False, raise_exception=False, smtp_session=None):
        ...
        for mail_id in self.ids:
            ...
            try:
                ...
                res = None
                bcc_sprit_emails = []
                company_email = self.env.user.company_id.notification_email or False
                if company_email:
                    bcc_sprit_emails.append(company_email)
                bcc_emails = ','.join(bcc_sprit_emails)
                for email in email_list:
                    msg = IrMailServer.build_email(
                        ...
                        email_bcc=tools.email_split(bcc_emails),
